...
def action(bot, update, args):
	...
	if fmUsers[str(uid)]['fmuser']:
		url = "http://ws.audioscrobbler.com/2.0/?method=user.getTopAlbums&format=json&user=" + fmUsers[str(uid)]['fmuser'] + "&api_key=" + lastfm_key + "&limit=5&period=7day"
